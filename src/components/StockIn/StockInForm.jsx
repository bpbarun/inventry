...
const empty = { branchId: "", parentCatId: "", subCatId: "", productId: "", qty: "", supplier: "", reference: "", notes: "", date: today() };
...
export default function StockInForm({ onSave, onCancel }) {
  ...
  // Root categories that have products in this branch
  ...
  // Effective category filter for products
  const effectiveCatId = f.subCatId
    ? parseInt(f.subCatId)
    : f.parentCatId
      ? null  // show all products under this parent (parent + all subs)
      : null;
